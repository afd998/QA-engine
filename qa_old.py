...
def A6_sentence_selection(question, story, all_scores = False):
...
def get_answer(question, story):
    ...
    score_dict = A6_sentence_selection(question, story, all_scores=True)
    global last_story
    ...
    if q_class == "who":
        if("PERSON") in possible:
            if len(possible["PERSON"]) == 1:
                print(question["question"], possible["PERSON"])
